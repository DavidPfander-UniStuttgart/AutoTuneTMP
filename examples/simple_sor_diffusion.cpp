...
size_t SORSolve(std::vector<double> &grid, const std::vector<double> &rhs, const double &eps) {
  ...
  autotune::tuners::bisect_search btune(autotune::SORDiffusion, parameters2, 10);
  ...
  autotune::SORDiffusion.set_parameter_values(tuner.tune(grid_r, grid_b, rhs_r, rhs_b, 
                                                          eps, res, rate, time, iter, itermax));
