...
AUTOTUNE_KERNEL(void(size_t, size_t), copy,
...
int main(void) {
  ...
  autotune::fixed_set_parameter<size_t> p1("KERNEL_THREADS", {8});
  ...
  //   -IVc_install/include"); builder.set_link_flags("-std=c++17 -O3 -g
  //   -fopenmp -fstrict-aliasing "); builder.set_do_cleanup(false);
