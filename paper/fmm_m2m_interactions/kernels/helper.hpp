...
inline real reciprocal_distance(const integer i0, const integer i1,
                                const integer i2, const integer j0,
...
// calculates 1/distance between i and j
inline m2m_int_vector
distance_squared_reciprocal(const multiindex<m2m_int_vector> &i,
                            const multiindex<m2m_int_vector> &j) {
