...
private:
  ...
  // so skip non-existing interaction partners faster, one entry per vector
  // variable
  ...
  // template <typename F>
  // void iterate_inner_cells_padded_stencil(multiindex<>& stencil_element, F&
  // f) {
  ...
  //         {
  //             for (size_t i2 = offset.z; i2 < INNER_CELLS_PER_DIRECTION; i2
  //             += 2) {
  //                 // for (size_t i0 = 0; i0 < INNER_CELLS_PER_DIRECTION; i0
  //                 += 1) {
  //                 //     for (size_t i1 = 0; i1 < INNER_CELLS_PER_DIRECTION;
  //                 i1 += 1) {
  //                 //         for (size_t i2 = 0; i2 <
  //                 INNER_CELLS_PER_DIRECTION; i2 += 1) {
