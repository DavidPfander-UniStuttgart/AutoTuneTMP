...
public:
  ...
  inline m2m_vector value(const size_t flat_index) const {
    return m2m_vector(this->pointer<component_access>(flat_index),
...
//     friend class struct_of_array_iterator<AoS_type, component_type,
//     num_components>;
...
//     flat_entry_index) {
//         return data.data() +
//             (component_index * padded_entries_per_component +
//             flat_entry_index);
//     }
...
//     get_view(size_t
//     flat_index) {
//         return struct_of_array_view<AoS_type, component_type,
//         num_components>(
//             *this, flat_index);
//     }
...
//         for (size_t component = 0; component < num_components; component++) {
//             for (size_t entry = 0; entry < org.size(); entry++) {
//                 org[entry][component] = data[component *
//                 padded_entries_per_component +
//                 entry];
//             }
//         }
